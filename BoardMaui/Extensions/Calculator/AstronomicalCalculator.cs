...
public abstract class AstronomicalCalculator : IAstronomicalCalculator
{
    ...
    public static IAstronomicalCalculator GetDefault() => new SunTimesCalculator();

    private double EarthRadius => 6356.9;
    ...
    private double GetElevationAdjustment(double elevation) => Math.Acos(EarthRadius / (EarthRadius + (elevation / 1000))).ToDegree();
    ...
    {
        return zenith == AstronomicalCalendar.GEOMETRIC_ZENITH
    ...
    /// </summary>
    /// <value></value>
    public abstract string CalculatorName
    {
        get;
    }
