...
public class NOAACalculator : AstronomicalCalculator
{
    ...
    private static readonly double JULIAN_DAY_JAN_1_2000 = 2451545.0;

    /// Julian days per century
    private static readonly double JULIAN_DAYS_PER_CENTURY = 36525.0;
    ...
    private static double GetJulianCenturiesFromJulianDay(double julianDay) => (julianDay - JULIAN_DAY_JAN_1_2000) / JULIAN_DAYS_PER_CENTURY;
    ...
    private static double GetJulianDayFromJulianCenturies(double julianCenturies) => (julianCenturies * JULIAN_DAYS_PER_CENTURY) + JULIAN_DAY_JAN_1_2000;
    ...
    private static double GetSunGeometricMeanAnomaly(double julianCenturies) => 357.52911 + (julianCenturies * (35999.05029 - (0.0001537 * julianCenturies))); // in degrees
    ...
    /// </returns>
    private static double GetSunHourAngleAtSunset(double lat, double solarDec, double zenith) => -GetSunHourAngleAtSunrise(lat, solarDec, zenith);// in radians
