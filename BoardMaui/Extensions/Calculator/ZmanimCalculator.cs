...
public class ZmanimCalculator : AstronomicalCalculator
{
    ...
    public override double GetUtcSunrise(
        IDateWithLocation dateWithLocation, double zenith, bool adjustForElevation) => GetUtcSunriseSunset(dateWithLocation, zenith, adjustForElevation, true);
    ...
    public override double GetUtcSunset(
        IDateWithLocation dateWithLocation, double zenith, bool adjustForElevation) => GetUtcSunriseSunset(dateWithLocation, zenith, adjustForElevation, false);
        ...
        IDateWithLocation dateWithLocation, double zenith, bool adjustForElevation, bool isSunrise)
    {
        ...
        rAscension += lQuadrant - rQuadrant;
        ...
        double latitudeRadians = dateWithLocation.Location.Latitude.ToRadians();
