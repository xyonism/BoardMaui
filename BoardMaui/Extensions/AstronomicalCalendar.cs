...
public class AstronomicalCalendar : IAstronomicalCalendar
{
    ...
    */
    ...
    public AstronomicalCalendar(IGeoLocation geoLocation)
        : this(DateTime.UtcNow, geoLocation) { }
    ...
    public virtual DateTime GetSunrise()
    {
        ...
        return double.IsNaN(sunrise) ? new() : GetDateFromTime(sunrise) ?? new();
    }
    ...
    public virtual DateTime? GetSeaLevelSunrise()
    {
        ...
        return double.IsNaN(sunrise) ? null : GetDateFromTime(sunrise);
    }
    ...
    public virtual DateTime? GetBeginCivilTwilight() => GetSunriseOffsetByDegrees(CIVIL_ZENITH);
    ...
    public virtual DateTime? GetBeginNauticalTwilight() => GetSunriseOffsetByDegrees(NAUTICAL_ZENITH);
    ...
    public virtual DateTime? GetBeginAstronomicalTwilight() => GetSunriseOffsetByDegrees(ASTRONOMICAL_ZENITH);
    ...
    public virtual DateTime GetSunset()
    {
        ...
        return double.IsNaN(sunset) ? new() : GetAdjustedSunsetDate(GetDateFromTime(sunset), GetSunrise()) ?? new();
    }
    ...
    /// See detailed explanation on top of the page.
    /// </returns>
    private DateTime? GetAdjustedSunsetDate(DateTime? sunset, DateTime? sunrise) => sunset == null || sunrise == null || sunrise.Value.CompareTo(sunset.Value) < 0 ? sunset : sunset.Value.AddDays(1);
    ...
    public virtual DateTime? GetSeaLevelSunset()
    {
        ...
        return double.IsNaN(sunset) ? null : GetAdjustedSunsetDate(GetDateFromTime(sunset), GetSeaLevelSunrise());
    }
    ...
    /// </returns>
    /// <seealso cref="CIVIL_ZENITH"/>
    public virtual DateTime? GetEndCivilTwilight() => GetSunsetOffsetByDegrees(CIVIL_ZENITH);
    ...
    /// </returns>
    /// <seealso cref="NAUTICAL_ZENITH"/>
    public virtual DateTime? GetEndNauticalTwilight() => GetSunsetOffsetByDegrees(NAUTICAL_ZENITH);
    ...
    /// </returns>
    /// <seealso cref="ASTRONOMICAL_ZENITH"/>
    public virtual DateTime? GetEndAstronomicalTwilight() => GetSunsetOffsetByDegrees(ASTRONOMICAL_ZENITH);
    ...
    /// </returns>
    public virtual DateTime? GetTimeOffset(DateTime time, double offset) => GetTimeOffset(time, (long)offset);

    protected virtual DateTime? GetTimeOffset(DateTime? time, double offset) => GetTimeOffset(time, (long)offset);
    ...
    /// to it
    /// </returns>
    public virtual DateTime? GetTimeOffset(DateTime time, long offset) => offset == long.MinValue ? null : time.AddMilliseconds(offset);

    protected virtual DateTime? GetTimeOffset(DateTime? time, long offset) => time == null ? null : GetTimeOffset(time.Value, offset);
    ...
    public virtual DateTime? GetSunriseOffsetByDegrees(double offsetZenith)
    {
        ...
        return double.IsNaN(alos) ? null : GetDateFromTime(alos);
    }
    ...
    public virtual DateTime? GetSunsetOffsetByDegrees(double offsetZenith)
    {
        ...
        return double.IsNaN(sunset) ? null : GetAdjustedSunsetDate(GetDateFromTime(sunset), GetSunriseOffsetByDegrees(offsetZenith));
    }
    ...
    /// See detailed explanation on top of the page.
    /// </returns>
    public virtual double GetUtcSunrise(double zenith) => AstronomicalCalculator.GetUtcSunrise(DateWithLocation, zenith, true);
    ...
    /// <seealso cref="GetUtcSeaLevelSunset"/>
    public virtual double GetUtcSeaLevelSunrise(double zenith) => AstronomicalCalculator.GetUtcSunrise(DateWithLocation, zenith, false);
    ...
    /// </returns>
    /// <seealso cref="GetUtcSeaLevelSunset"/>
    public virtual double GetUtcSunset(double zenith) => AstronomicalCalculator.GetUtcSunset(DateWithLocation, zenith, true);
    ...
    /// <seealso cref="GetUtcSeaLevelSunrise"/>
    public virtual double GetUtcSeaLevelSunset(double zenith) => AstronomicalCalculator.GetUtcSunset(DateWithLocation, zenith, false);
    ...
    /// will be returned.
    /// </returns>
    public virtual long GetTemporalHour() => GetTemporalHour(GetSunrise(), GetSunset());
    ...
    public virtual long GetTemporalHour(DateTime sunrise, DateTime sunset)
    {
        ...
        return sunrise == DateTime.MinValue || sunset == DateTime.MinValue
            ? long.MinValue
            : (long)((sunset - sunrise).TotalMilliseconds / 12);
    }

    protected virtual long GetTemporalHour(DateTime? sunrise, DateTime? sunset) => sunrise == null || sunset == null ? long.MinValue : (long)((sunset - sunrise).Value.TotalMilliseconds / 12);
    ...
    /// <seealso cref="GetTemporalHour"/>
    public virtual DateTime? GetSunTransit() => GetSunTransit(GetSeaLevelSunrise(), GetSeaLevelSunset());
    ...
    protected internal virtual DateTime? GetDateFromTime(double time)
    {
        ...
        DateTime date = DateWithLocation.Date;
    ...
    public virtual double GetSunriseSolarDipFromOffset(double minutes)
    {
        ...
        DateTime? offsetByTime = GetTimeOffset(GetSeaLevelSunrise().Value, -(minutes * MINUTE_MILLIS));

        decimal degrees = 0m;
        decimal incrementor = 0.0001m;
    ...
    public virtual double GetSunsetSolarDipFromOffset(double minutes)
    {
        ...
        DateTime? offsetByTime = GetTimeOffset(GetSeaLevelSunset().Value, minutes * MINUTE_MILLIS);

        decimal degrees = 0m;
        decimal incrementor = 0.001m;
        while (offsetByDegrees == null || offsetByDegrees.Value.ToUnixEpochMilliseconds() < offsetByTime.Value.ToUnixEpochMilliseconds())
        {
            degrees += incrementor;
    ...
    public override string ToString() => ZmanimFormatter.ToXml(this);
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj is not AstronomicalCalendar)
        {
            return false;
        }

        AstronomicalCalendar aCal = (AstronomicalCalendar)obj;
    ...
    public virtual IAstronomicalCalculator AstronomicalCalculator
    {
        get; set;
    }
    ...
    public virtual IDateWithLocation DateWithLocation
    {
        get; set;
    }
}