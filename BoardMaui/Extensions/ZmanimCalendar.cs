...
public class ZmanimCalendar : AstronomicalCalendar
{
    ...
    /// </returns>
    /// <seealso cref="ZENITH_8_POINT_5"/>
    public virtual DateTime? GetTzais() => GetSunsetOffsetByDegrees(ZENITH_8_POINT_5);
    ...
    /// <see cref="AstronomicalCalendar"/> documentation.
    /// </returns>
    public virtual DateTime GetAlosHashachar() => GetSunriseOffsetByDegrees(ZENITH_16_POINT_1) ?? new();
    ...
    /// <see cref="AstronomicalCalendar"/> documentation.
    /// </returns>
    public virtual DateTime? GetAlos72() => GetTimeOffset(GetSeaLevelSunrise().Value, -72 * MINUTE_MILLIS);
    ...
    /// <see cref="AstronomicalCalendar"/> documentation.
    ///  </returns>
    public virtual DateTime GetChatzos() => GetSunTransit() ?? new();
    ...
    ///         <seealso cref="AstronomicalCalendar"/> documentation. </returns>
    public virtual DateTime GetSofZmanShmaGRA() => GetSofZmanShma(GetSeaLevelSunrise(), GetSeaLevelSunset()) ?? new();
    ...
    public virtual DateTime? GetSofZmanShmaMGA() => GetSofZmanShma(GetAlos72(), GetTzais72());
    ...
    /// <see cref="AstronomicalCalendar"/> documentation.
    ///  </returns>
    public virtual DateTime? GetTzais72() => GetTimeOffset(GetSeaLevelSunset().Value, 72 * MINUTE_MILLIS);
    ...
    /// of non-sea level sunset, pass the elevation adjusted sunset to <seealso cref="AstronomicalCalendar.GetTimeOffset(DateTime?,long)"/>.
    /// </summary>
    /// <returns>
    ...
    public virtual DateTime? GetCandleLighting() => GetTimeOffset(GetSeaLevelSunset().Value, -CandleLightingOffset * MINUTE_MILLIS);
    ...
    /// </returns>
    /// <seealso cref="GetShaahZmanisGra"/>
    public virtual DateTime? GetSofZmanTfilaGRA() => GetSofZmanTfila(GetSeaLevelSunrise(), GetSeaLevelSunset());
    ...
    public virtual DateTime? GetSofZmanTfilaMGA() => GetTimeOffset(GetAlos72().Value, GetShaahZmanisMGA() * 4);
    ...
    public virtual DateTime GetMinchaGedola() => GetMinchaGedola(GetSeaLevelSunrise(), GetSeaLevelSunset()) ?? new();
    ...
    public virtual DateTime? GetMinchaKetana() => GetMinchaKetana(GetSeaLevelSunrise(), GetSeaLevelSunset());
    ...
    /// <see cref="AstronomicalCalendar"/> documentation.
    /// </returns>
    public virtual DateTime GetPlagHamincha() => GetPlagHamincha(GetSeaLevelSunrise(), GetSeaLevelSunset()) ?? new();
    ...
    public virtual long GetShaahZmanisGra() => GetTemporalHour(GetSeaLevelSunrise().Value, GetSeaLevelSunset().Value);
    ...
    /// top of the <see cref="AstronomicalCalendar"/> documentation.
    /// </returns>
    public virtual long GetShaahZmanisMGA() => GetTemporalHour(GetAlos72().Value, GetTzais72().Value);
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj is not ZmanimCalendar)
        {
            return false;
        }

        ZmanimCalendar zCal = (ZmanimCalendar)obj;
    ...
    {
        get => candleLightingOffset; set => candleLightingOffset = value;
    }
}