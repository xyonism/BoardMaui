...
public class Time
{
    ...
    /// </summary>
    /// <returns></returns>
    public virtual double GetTime() => (Hours * HOUR_MILLIS) + (Minutes * MINUTE_MILLIS) + (Seconds * SECOND_MILLIS) + Milliseconds;
    ...
    /// </returns>
    public override string ToString() => new ZmanimFormatter().Format(this);
}