...
public class WindowsTimeZone : ITimeZone
{
    ...
    public WindowsTimeZone(TimeZoneInfo timeZone) => TimeZone = timeZone;
    ...
    public WindowsTimeZone(string timeZoneName) => TimeZone = TimeZoneInfo.FindSystemTimeZoneById(timeZoneName);
#endif
    ...
    /// <returns></returns>
    public int UtcOffset(DateTime dateTime) => (int)TimeZone.GetUtcOffset(dateTime).TotalMilliseconds;
    ...
    /// <param name="dateTime">The date time.</param>
    /// <returns></returns>
    public bool IsDaylightSavingTime(DateTime dateTime) => TimeZone.IsDaylightSavingTime(dateTime);
    ...
    /// </summary>
    /// <returns></returns>
    public string GetDisplayName() => TimeZone.StandardName;
